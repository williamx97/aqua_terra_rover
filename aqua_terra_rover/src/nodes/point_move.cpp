...
int main(int argc, char* argv[])
{
	...
	{	;;
        ...
        if(abs(error_distance) > 0.5 && abs(error_xy_heading) > 0.7)
        {
            alg_case = 1;
        }
        else if (abs(error_distance) > 0.5 && abs(error_xy_heading) < 0.7)
        {
            alg_case = 2;
        }
        else if (abs(error_distance) < 0.5 && abs(error_heading) > 0.7)
        {
            alg_case = 3;
        }
        else
