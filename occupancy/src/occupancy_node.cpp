...
int main(int argc, char **argv)
{
    ...
    boost::shared_ptr<sensor_msgs::CameraInfo const> msg_cameraInfo = ros::topic::waitForMessage<sensor_msgs::CameraInfo>("D435/depth/camera_info", n);  // TODO: make topic name configureable
    ...
    std::string target_frameid = "D435_depth_optical_frame";
    ...
    ros::Subscriber sub_depth = n.subscribe("D435/depth/image_rect_raw", 1, depthCallback, ros::TransportHints().udp());
